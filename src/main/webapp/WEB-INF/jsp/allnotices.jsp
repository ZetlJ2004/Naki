...
<div class="content">
        <div class="con_right">
            ...
            <div class="con_right_content wenzhang_content">
                <style>.wenzhang_content table{margin:0 auto; display:table;}
                .wenzhang_content table tr td{border-color:#dadada !important;}
                </style>

                <div class="index_con_news">
                    <ul>
                        <c:forEach items="${Notices}" var="u" >
