...
<a href="filter/manger" class="btn_news">管理新闻</a>
<a href="filter/manger2" class="btn_news">管理公告</a>
<hr>
<a href="addnotices" class="btn_change">新增公告</a>
<div class="inf">
    <table>
        <tr>
            <th>公告编号</th>
        ...
        <c:forEach items="${Newses}" var="u">
            <tr>
                ...
                <td>${u.updateTime}</td>
                <td>
                    <a href="shownotices?id=${u.id}" class="btn_change">预览</a>
                    <a href="editnotice?id=${u.id}" class="btn_change">修改</a>
                    <a href="deletenotice?id=${u.id}" class="btn_delete">删除</a>
                </td>
            </tr>
        </c:forEach>
    </table>
