...
<hr>
<a href="addnews" class="btn_change">新增新闻</a>
<div class="inf">
<table>
    <tr>
        <th>新闻编号</th>
    ...
    <c:forEach items="${Newses}" var="u">
        <tr>
            ...
            <td>${u.updateTime}</td>
            <td>
                <a href="shownews?id=${u.id}" class="btn_change">预览</a>
                <a href="editnew?id=${u.id}" class="btn_change">修改</a>
                <a href="delete?id=${u.id}" class="btn_delete">删除</a>
            </td>
        </tr>
    </c:forEach>
</table>
